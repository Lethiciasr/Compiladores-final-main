...
{
       0,    79,    79,    86,    87,    88,    92,    93,    94,    95,
      96,   101,   101,   122,   129,   130,   134,   145,   161,   161,
     169,   170,   174,   179,   183,   184,   185,   186,   187,   188,
     189,   190,   211,   235,   250,   260,   269,   277,   285,   319,
     324,   324,   338,   339,   343,   363,   397,   398,   399,   400,
     401,   433,   445,   464,   464,   490,   490,   513,   522,   528,
     513,   544,   544,   561,   561,   576,   580,   585,   589,   603,
     617,   631,   645,   653,   661,   669,   677,   685,   693,   701,
     709,   717,   725,   734,   738,   742,   751,   757,   763,   769,
     776,   782,   787,   804,   828,   829,   833,   837
};
#endif
...
#line 397 "sin.y"
                                { /* omitido por brevidade */ (yyval.info).c_expr = strdup(""); }
#line 1856 "sin.tab.c"
    break;
...
#line 725 "sin.y"
        ...
        sprintf(c_out, "(%s)(%s)", s_tipo, (yyvsp[0].info).c_expr); (yyval.info).c_expr = c_out;
    }
#line 2355 "sin.tab.c"
    break;
...
#line 742 "sin.y"
        ...
        if (s == NULL) {
            ...
            (yyval.info).temp = s->temp; (yyval.info).tipo_val = s->tipo; (yyval.info).c_expr = s->nome;
        }
    }
#line 2381 "sin.tab.c"
    break;
...
#line 776 "sin.y"
        ...
        strcat(instrucoes, buf);
        (yyval.info).temp = t; (yyval.info).tipo_val = T_BOOL; (yyval.info).c_expr = strcmp((yyvsp[0].valor_str),"true")==0 ? "true" : "false";
    }
#line 2437 "sin.tab.c"
    break;
